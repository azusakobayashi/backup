...
<head>
	...
	<script>
		...
		$('#link_1A').toggle (function () {
			...
			/* $('#title_main').html('First Link Title<br />First Link Source')
			.stop(); */
		}, function() {
			...
			/* $('#title_main').html('The Great Accelerator<br />Paul Virilio') 
			.stop();*/
		});
		
		$('#link_1B').toggle(function () {
			$('.path_1B_text').slideToggle('slow');
			$('body,html').animate({
					scrollTop: 0
				}, 800);
			/* $('#title_main').html('Second Link Title<br />Second Link Source') 
			.stop();*/
		}, function() {
